...
// Ambil Data yang Dikirim dari Form
            $id_testimoni  = mysqli_real_escape_string($mysqli, trim($_POST['id_testimoni']));
            $judul_testimoni  = mysqli_real_escape_string($mysqli, trim($_POST['judul_testimoni']));
            $isi_testimoni  = mysqli_real_escape_string($mysqli, trim($_POST['isi_testimoni']));
